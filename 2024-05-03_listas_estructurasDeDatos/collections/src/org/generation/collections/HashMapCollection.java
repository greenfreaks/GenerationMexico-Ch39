...
public class HashMapCollection {
    public static void main(String[] args) {
        /*------HASSMAP--------*/
        //Almacena elementos en pares (key/value) y se puede acceder a ellos mediante el index. No es ordenado y no permite datos duplicados
        ...
        //Recorrer un HashMap, vamos a implementar un método de la interfazMap que se llama Entry
